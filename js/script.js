...
// 1st question
// prompt 1st question
let thailand = prompt('Was I born in Thailand? y/n or yes/no');
...
// 2nd question
// prompt 2nd question
let marines = prompt('Did I served in the Marine Corps? y/n or yes/no');
...
// 3rd question
// prompt 3rd question
let psu = prompt('Did I go to Portland State University? y/n or yes/no');
...
// 4th question
// prompt 4th question
let up = prompt('Did I go to University of Portland? y/n or yes/no');
...
// 5th question
// prompt 5th question
let codefellow = prompt('Am I currently attending Code Fellows? y/n or yes/no');
